...
function Swap(props) {
  ...
  function changeAmount(e){
    ...
    if(e.target.value && prices){
      setTokenTwoAmount((e.target.value * prices.usdPrices.ratio).toFixed(2))
  ...
  async function fetchDexSwap(){
    ...
    setTokenTwoAmount((Number(tx.data.toTokenAmoun)/decimals).toFixed(2));
